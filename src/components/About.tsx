  ...
  return (
    <div className='card' id='about'>
      <div className='card-content'>
        ...
        <div className='text'>
          Hello there! I'm a software developer who loves to learn and help
          others grow. I'm always looking to make a positive impact, both at
          ...
          <a onClick={() => navigate("skills")}>technologies</a>. I'm a graduate
          of{" "}
